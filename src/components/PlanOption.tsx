...
const PlanOption: React.FC = () => {
  return (
    <div style={{ background: 'linear-gradient(135deg, #e0e7ff 0%, #f8fafc 100%)', minHeight: '100vh', padding: '0' }}>
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '64px 16px 0 16px', textAlign: 'center' }}>
        ...
        {/* プラン一覧 */}
        <div style={{ display: 'flex', gap: 48, flexWrap: 'wrap', justifyContent: 'center', marginBottom: 56 }}>
          {/* ライトプラン */}
          <div style={{ background: '#fff', borderRadius: 20, boxShadow: '0 6px 32px #bdbdbd22', padding: 48, minWidth: 320, flex: 1, maxWidth: 400, margin: '0 12px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          {/* ベーシックプラン */}
          <div style={{ background: '#fff', borderRadius: 20, boxShadow: '0 6px 32px #bdbdbd22', padding: 48, minWidth: 320, flex: 1, maxWidth: 400, margin: '0 12px', border: '2.5px solid #764ba2', position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        {/* オプション */}
        <div style={{ background: '#fff', borderRadius: 20, boxShadow: '0 4px 20px #bdbdbd22', padding: 48, margin: '0 auto 56px auto', maxWidth: 800, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 40, justifyContent: 'center', width: '100%' }}>
            ...
            <div style={{ minWidth: 200, flex: 1, opacity: 0.7, position: 'relative' }}>
